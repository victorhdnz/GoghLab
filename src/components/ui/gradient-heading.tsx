...
const headingVariants = cva(
  "tracking-tight pb-3 bg-clip-text text-transparent",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-t from-gogh-black to-gogh-grayDark dark:from-stone-200 dark:to-neutral-200",
        yellow:
          "bg-gradient-to-t from-gogh-yellow-dark to-gogh-yellow dark:from-gogh-yellow dark:to-gogh-yellow-light",
        light: "bg-gradient-to-t from-neutral-200 to-neutral-300",
        secondary:
          "bg-gradient-to-t from-gogh-grayDark to-gogh-black/80 dark:from-stone-200 dark:to-neutral-200",
      },
      size: {
...
export type Variant = "default" | "yellow" | "light" | "secondary"
export type Size =
  | "default"
  | "xxs"
  | "xs"
