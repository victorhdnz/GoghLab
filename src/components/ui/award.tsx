...
const levelColors = {
  ...
  gold: "from-gogh-yellow to-gogh-yellow-dark",
...
export function Awards({
      ...
      >
        ...
        >
          ...
          <path
            ...
            strokeWidth="0.2"
            className="fill-gogh-beige stroke-gogh-black dark:fill-gogh-black dark:stroke-white"
          />
          ...
          <text className="fill-gogh-black text-xl font-bold">
            <textPath
              href="#top-curve"
              startOffset="50%"
              textAnchor="middle"
              className="fill-gogh-black dark:fill-white"
            >
              {title}
            </textPath>
          </text>
        ...
        <div className="relative z-10 text-center">
          {showIcon && (
            <div className="mb-1 flex justify-center text-center text-2xl">
              <Star className="text-gogh-yellow fill-gogh-yellow" />
            </div>
          )}
          {recipient && (
            <div className="text-gogh-yellow mt-2 text-[14px]">{recipient}</div>
          )}
          {date && <div className="text-[10px] italic text-gogh-grayDark">{date}</div>}
        </div>
      </div>
    )
  }
  ...
  if (variant === "award") {
    const LaurelWreath = () => (
      <svg
        className={cn("fill-gogh-yellow absolute top-1/2 h-full w-full -translate-y-1/2")}
        width="892.77"
        height="688.08"
    ...
    return (
      ...
      >
        ...
        <div className="z-10 px-8 text-center">
          <div
            className={cn(
              "mt-6 mb-2 inline-block rounded-md px-4 py-1 tracking-wider text-gogh-black",
          ...
          <h1 className={cn("text-4xl font-black tracking-tight text-gogh-black")}>{title}</h1>

          <div className="bg-gogh-yellow mx-auto my-3 h-[1px] w-40"></div>

          <h2 className={cn("mb-4 w-60 text-xl font-light text-gogh-grayDark")}>{subtitle}</h2>

          {recipient && (
            <p className={cn("text-gogh-grayDark italic")}>{recipient}</p>
          )}

          <div className={cn("text-xl font-bold text-gogh-black")}>{date}</div>
        </div>
      </div>
    )
  }
  ...
  if (variant === "certificate") {
    const Badge = () => (
      <svg
        className={cn("fill-gogh-yellow -mt-12 h-18 w-full overflow-hidden")}
        width="24"
        height="24"
        viewBox="0 0 24 24"
      >
    ...
    return (
      <div
        className={cn(
          "relative z-0",
          "flex flex-col items-center justify-center rounded-xl border-2 border-dotted border-gogh-yellow/50 p-2",
          "overflow-hidden bg-gogh-beige",
          className
        )}
      >
        <div className="bg-white z-10 rounded-sm border border-gogh-yellow/30 p-6 px-8 text-center">
          <Badge />
          <h1
            className={cn(
              "mt-4 grid text-3xl leading-7 font-bold tracking-tighter uppercase text-gogh-black"
            )}
          >
            Certificate
            <span className="text-sm font-light tracking-tight text-gogh-grayDark">
              {" "}
              of {title}
            </span>
          </h1>

          <p className="text-gogh-grayDark mt-4 mb-1 text-xs">
            This is to certify that
          </p>
          <h1
            className={cn(
              "text-gogh-yellow-dark mb-2 border-b border-gogh-yellow/30 text-xl font-semibold tracking-tight"
            )}
          >
            {recipient}
          </h1>

          <p className="text-gogh-grayDark mb-1 text-xs">{subtitle}</p>
          <div className="mt-6 flex justify-center">
            <Award strokeWidth={1} className="h-4 w-4 text-gogh-yellow" />
          </div>
          <div className={cn("mt-2 text-xs text-gogh-grayDark")}>Awarded on: {date}</div>
        </div>
      </div>
    )
  }
  ...
  if (variant === "badge") {
    const Badge = () => (
      <svg
        className={cn("fill-gogh-yellow h-full w-18 overflow-hidden")}
        width="500.15"
        height="620.78"
    ...
    return (
      <div className={cn("", className)}>
        <div
          className={cn("rounded-md border-4 border-gogh-yellow/50 p-4 bg-white", "flex justify-start gap-3")}
        >
          <Badge />
          <div className={cn("border-l border-gogh-yellow/30 px-3")}>
            <h1
              className={cn("text-gogh-yellow-dark text-4xl font-bold tracking-tight")}
            >
              {title}
            </h1>
            <h2 className={cn("text-gogh-grayDark text-md font-light")}>
              {subtitle}
            </h2>

            <div className="mt-1 flex items-center gap-4 text-xs text-gogh-grayDark">
        ...
        <div className="relative text-center">
          <span
            ...
            style={{
              ...
              WebkitTextStroke: "10px var(--gogh-beige)",
            }}
          >
            {title}
          </span>
          ...
          <span
            className="text-gogh-yellow relative text-7xl font-black tracking-tighter"
            style={{
              WebkitBackgroundClip: "text",
              WebkitTextFillColor: "transparent",
              backgroundImage: "linear-gradient(to bottom, #F7C948, #E5A800)",
            }}
          >
            {title}
          </span>
  ...
  if (variant === "id-card") {
    return (
      <div className={cn("flex bg-white items-center rounded-md border border-gogh-yellow/30 shadow-lg p-1 justify-center", className)}>
        <div className="relative h-100 w-72 rounded-sm overflow-hidden border-4 border-gogh-yellow/50">
          
          <span className="absolute top-8 right-8 flex h-4 w-4 items-center justify-center">
            <span className="bg-gogh-yellow absolute inline-flex h-full w-full animate-ping rounded-full opacity-75"></span>
            <span className="bg-gogh-yellow relative inline-flex h-3 w-3 rounded-full"></span>
          </span>

          <div className="mt-24 px-6">
            <div
              className={cn(
                "bg-gogh-beige mb-4 w-fit rounded-md border border-gogh-yellow/30 px-4 py-2 text-xs text-gogh-grayDark"
              )}
            >
              {date}
            </div>
            <h1 className="text-5xl leading-tight font-bold text-gogh-black">{title}</h1> 
            <p className="text-gogh-grayDark -mt-2 text-md font-light tracking-wider">
              {subtitle}
            </p>
          </div>
          <div className="absolute bottom-6 w-full border-t border-gogh-yellow/30">
            <div className="mt-6 flex justify-between px-6">
              <div>
                <div className="text-xs text-gogh-grayDark">VIRTUAL</div>
                <div className="text-gogh-yellow-dark text-lg font-semibold">
                  {description}
                </div>
              </div>
              <div className="p-3"> 
                <Star className="h-6 w-6 text-gogh-yellow fill-gogh-yellow" />
              </div>
            </div>
          </div>
        </div>
