    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 pt-10 pb-8 sm:pt-16 sm:pb-10 lg:pt-28 lg:pb-12 space-y-5 sm:space-y-8 relative">
      ...
      <section id="perfil-marca" className="bg-white rounded-2xl border border-gogh-grayLight p-4 sm:p-6">
        ...
        <div className="space-y-4">
          {/* Identificação */}
          <div id="perfil-identificacao" className={`rounded-xl border-2 transition-colors ${getAccordionCardClass('identificacao')}`}>
            <button
              type="button"
            ...
            >
              <span className="text-lg font-semibold text-gogh-black">Identificação</span>
              {profileAccordionOpen === 'identificacao' ? <ChevronDown className="w-5 h-5 text-gogh-grayDark" /> : <ChevronRight className="w-5 h-5 text-gogh-grayDark" />}
            </button>
            {profileAccordionOpen === 'identificacao' && (
              <div className="px-4 pb-4 pt-0 border-t border-gogh-grayLight/50 space-y-4">
          ...
          {/* Público-alvo */}
          <div id="perfil-publico-alvo" className={`rounded-xl border-2 transition-colors ${getAccordionCardClass('publico-alvo')}`}>
            <button
              type="button"
              onClick={() => setProfileAccordionOpen(profileAccordionOpen === 'publico-alvo' ? null : 'publico-alvo')}
              className="w-full flex items-center justify-between p-4 text-left hover:opacity-90 transition-opacity"
            >
              <span className="text-lg font-semibold text-gogh-black">Público-alvo</span>
              {profileAccordionOpen === 'publico-alvo' ? <ChevronDown className="w-5 h-5 text-gogh-grayDark" /> : <ChevronRight className="w-5 h-5 text-gogh-grayDark" />}
            </button>
            {profileAccordionOpen === 'publico-alvo' && (
              <div className="px-4 pb-4 pt-0 border-t border-gogh-grayLight/50 pt-3">
          ...
          {/* Tom de voz */}
          <div id="perfil-tom-de-voz" className={`rounded-xl border-2 transition-colors ${getAccordionCardClass('tom-de-voz')}`}>
            <button
              type="button"
              onClick={() => setProfileAccordionOpen(profileAccordionOpen === 'tom-de-voz' ? null : 'tom-de-voz')}
              className="w-full flex items-center justify-between p-4 text-left hover:opacity-90 transition-opacity"
            >
              <span className="text-lg font-semibold text-gogh-black">Tom de voz</span>
              {profileAccordionOpen === 'tom-de-voz' ? <ChevronDown className="w-5 h-5 text-gogh-grayDark" /> : <ChevronRight className="w-5 h-5 text-gogh-grayDark" />}
            </button>
            {profileAccordionOpen === 'tom-de-voz' && (
              <div className="px-4 pb-4 pt-0 border-t border-gogh-grayLight/50 pt-3">
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-gogh-grayLight rounded-lg text-sm max-w-md"
                >
          ...
          <div id="perfil-estrategia-roteiro" className={`rounded-xl border-2 transition-colors ${getAccordionCardClass('estrategia-roteiro')}`}>
            <button
              type="button"
              onClick={() => setProfileAccordionOpen(profileAccordionOpen === 'estrategia-roteiro' ? null : 'estrategia-roteiro')}
              className="w-full flex items-center justify-between p-4 text-left hover:opacity-90 transition-opacity"
            >
              <span className="text-lg font-semibold text-gogh-black">Estratégia de roteiro</span>
              {profileAccordionOpen === 'estrategia-roteiro' ? <ChevronDown className="w-5 h-5 text-gogh-grayDark" /> : <ChevronRight className="w-5 h-5 text-gogh-grayDark" />}
            </button>
            {profileAccordionOpen === 'estrategia-roteiro' && (
              <div className="px-4 pb-4 pt-0 border-t border-gogh-grayLight/50 pt-3">
                ...
                <select
                  ...
                  onChange={(e) => setProfileForm((f) => ({ ...f, script_strategy_key: getScriptStrategy(e.target.value).key }))}
                  className="w-full px-3 py-2 border border-gogh-grayLight rounded-lg text-sm max-w-md"
                >
          ...
          <div id="perfil-plataforma-videos" className={`rounded-xl border-2 transition-colors ${getAccordionCardClass('plataforma-videos')}`}>
            <button
              type="button"
              onClick={() => setProfileAccordionOpen(profileAccordionOpen === 'plataforma-videos' ? null : 'plataforma-videos')}
              className="w-full flex items-center justify-between p-4 text-left hover:opacity-90 transition-opacity"
            >
              <span className="text-lg font-semibold text-gogh-black">Plataforma dos vídeos</span>
              {profileAccordionOpen === 'plataforma-videos' ? <ChevronDown className="w-5 h-5 text-gogh-grayDark" /> : <ChevronRight className="w-5 h-5 text-gogh-grayDark" />}
            </button>
          ...
          <div id="perfil-objetivos-videos" className={`rounded-xl border-2 transition-colors ${getAccordionCardClass('objetivos-videos')}`}>
            <button
              type="button"
              onClick={() => setProfileAccordionOpen(profileAccordionOpen === 'objetivos-videos' ? null : 'objetivos-videos')}
              className="w-full flex items-center justify-between p-4 text-left hover:opacity-90 transition-opacity"
            >
              <span className="text-lg font-semibold text-gogh-black">Objetivos com os vídeos</span>
              {profileAccordionOpen === 'objetivos-videos' ? <ChevronDown className="w-5 h-5 text-gogh-grayDark" /> : <ChevronRight className="w-5 h-5 text-gogh-grayDark" />}
            </button>
          ...
          <div id="perfil-frequencia" className={`rounded-xl border-2 transition-colors ${getAccordionCardClass('frequencia')}`}>
            <button
              type="button"
              onClick={() => setProfileAccordionOpen(profileAccordionOpen === 'frequencia' ? null : 'frequencia')}
              className="w-full flex items-center justify-between p-4 text-left hover:opacity-90 transition-opacity"
            >
              <span className="text-lg font-semibold text-gogh-black">Frequência desejada por semana</span>
              {profileAccordionOpen === 'frequencia' ? <ChevronDown className="w-5 h-5 text-gogh-grayDark" /> : <ChevronRight className="w-5 h-5 text-gogh-grayDark" />}
            </button>
