  ...
  return (
    <div className={clsx('relative inline-block', className)} id={id}>
      <button
        ...
        style={
          {
            ['--highlight-hue' as string]: String(highlightHueDeg),
      ...
      >
        ...
        <div className="ui-anim-txt-wrapper relative flex shrink-0 items-center">
          <span className="invisible whitespace-nowrap px-px" aria-hidden>
            {labelIdle}
          </span>
          <div
            className={clsx(
              'ui-anim-txt-1 absolute left-0 top-0 flex items-center justify-center whitespace-nowrap',
          ...
          <div
            className={clsx(
              'ui-anim-txt-2 absolute left-0 top-0 flex items-center justify-center whitespace-nowrap',
