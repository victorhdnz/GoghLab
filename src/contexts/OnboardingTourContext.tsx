...
const unifiedStepsDesktop: TourStep[] = [
  ...
  { selector: '[data-tour="nav-create-desktop"]', title: 'Criar', description: 'Este ícone abre o menu com Gogh Agenda (planejamento com IA) e Gogh Analytics (métricas).' },
...
const unifiedStepsMobile: TourStep[] = [
  ...
  { selector: '[data-tour="nav-create-mobile"]', title: 'Criar', description: 'Este ícone abre o menu com Gogh Agenda (planejamento com IA) e Gogh Analytics (métricas).' },
